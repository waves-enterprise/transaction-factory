...
import com.wavesplatform.acl.{OpType, PermissionOp, Role}
...
import com.wavesplatform.transaction.protobuf.{
...
import com.wavesplatform.transaction.transfer.{MassTransferTransaction, ParsedTransfer, TransferTransaction}
