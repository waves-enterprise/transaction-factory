...
import com.wavesenterprise.lang.v1.parser.Expressions.Pos.AnyPos
import com.wavesenterprise.lang.v1.parser.Expressions._
import com.wavesenterprise.lang.v1.parser.{BinaryOperation, Parser}
import com.wavesenterprise.lang.v1.testing.ScriptGenParser
...
class ParserTest extends PropSpec with ScalaCheckPropertyChecks with Matchers with ScriptGenParser with NoShrink {
  ...
  property("parser StackOverflow check") {
    ...
    Parser(script) shouldBe an[Success[_]]
  }
}
