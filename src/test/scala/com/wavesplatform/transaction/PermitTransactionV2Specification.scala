...
import com.wavesplatform.transaction.acl.{PermitTransaction, PermitTransactionV2}
...
class PermitTransactionV2Specification extends PropSpec with ScalaCheckPropertyChecks with Matchers with TransactionGen {
