...
import com.wavesplatform.transaction.smart.SetScriptTransactionV1
...
class SetScriptTransactionV1Specification extends GenericTransactionSpecification[SetScriptTransactionV1] {
  ...
  override def transactionParser: com.wavesplatform.transaction.TransactionParserFor[SetScriptTransactionV1] = SetScriptTransactionV1
  ...
  override def generator: Gen[((Seq[com.wavesplatform.transaction.Transaction], SetScriptTransactionV1))] =
