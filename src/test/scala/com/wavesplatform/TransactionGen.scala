...
import com.wavesplatform.acl.OpType.{Add, Remove}
import com.wavesplatform.acl.{OpType, PermissionOp, PermissionsGen}
import com.wavesplatform.lang.GostGlobal
import com.wavesplatform.lang.ScriptVersion.Versions.V1
import com.wavesplatform.lang.v1.compiler.CompilerV1
import com.wavesplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
import com.wavesplatform.lang.v1.testing.ScriptGen
import com.wavesplatform.privacy.PolicyDataHash
import com.wavesplatform.settings.TestFeeSettings
import com.wavesplatform.state._
import com.wavesplatform.transaction._
import com.wavesplatform.transaction.acl.{PermitTransactionV1, PermitTransactionV2}
import com.wavesplatform.transaction.assets._
import com.wavesplatform.transaction.assets.exchange._
import com.wavesplatform.transaction.lease._
import com.wavesplatform.transaction.smart.script.Script
import com.wavesplatform.transaction.smart.script.v1.ScriptV1
import com.wavesplatform.transaction.smart.{SetScriptTransactionV1, SetScriptValidation}
import com.wavesplatform.transaction.transfer._
import com.wavesplatform.transaction.validation.TransferValidation.MaxTransferCount
import com.wavesplatform.transaction.validation.{DataValidation, IssueTransactionValidation, PolicyValidation, TransferValidation}
...
trait TransactionGen extends ScriptGen with CommonGen with NTPTime { _: Suite =>
  ...
  val scriptGen = BOOLgen(100).map {
    case (expr, _) =>
      val typed =
        CompilerV1(PureContext.build(V1).compilerContext |+| CryptoContext.compilerContext(GostGlobal), expr).explicitGet()
  ...
  def createLease(sender: PrivateKeyAccount, amount: Long, fee: Long, timestamp: Long, recipient: AddressOrAlias): Gen[LeaseTransactionV2] = {
    val v2 = LeaseTransactionV2.selfSigned(None, sender, recipient, amount, fee, timestamp).explicitGet()
    Gen.const(v2)
  }

  def createLeaseCancel(sender: PrivateKeyAccount, leaseId: ByteStr, cancelFee: Long, timestamp: Long): Gen[LeaseCancelTransactionV2] = {
  ...
  val leaseV2Gen: Gen[LeaseTransactionV2] = leaseParamGen.flatMap {
    case (sender, amount, fee, timestamp, recipient) =>
      createLease(sender, amount, fee, timestamp, recipient)
  }
  ...
  def issueReissueBurnGeneratorP(issueQuantity: Long,
                                 ...
                                 timestampGen: Gen[Long] = timestampGen): Gen[(IssueTransaction, ReissueTransaction, BurnTransaction)] =
    for {
