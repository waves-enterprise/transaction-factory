...
import com.wavesplatform.transaction.base.{Code, ProtoAdapterImport}
import com.wavesplatform.transaction.generator.scala.AtomicInnerTxAdapterGenerator
...
object FieldType extends Enum[FieldType] {
  ...
  case object SCRIPT
      extends FieldType(
        ...
        scalaImports = Set(
          ...
          "com.wavesplatform.serialization.BinarySerializer",
          "com.wavesplatform.transaction.smart.script.ScriptReader",
          ProtoAdapterImport
        ),
  ...
  case object SHORT_STRING
      extends FieldType(
        scalaType = "String",
        protoType = "string",
        scalaImports = Set("com.google.common.primitives.Longs", "com.wavesplatform.serialization.BinarySerializer"),
  ...
  case object ASSET_ID
      extends FieldType(
        scalaType = "AssetId",
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.state.ByteStr", "com.wavesplatform.transaction.{AssetId, AssetIdLength}", ProtoAdapterImport),
  ...
  case object SHORT_BYTE_ARRAY
      extends FieldType(
        ...
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.serialization.BinarySerializer", ProtoAdapterImport),
  ...
  case object PUBLIC_KEY_ACCOUNT
      extends FieldType(
        ...
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.account.PublicKeyAccount", "com.wavesplatform.crypto.KeyLength"),
  ...
  case object ADDRESS
      extends FieldType(
        scalaType = "Address",
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.account.Address"),
  ...
  case object ALIAS
      extends FieldType(
        scalaType = "Alias",
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.account.Alias"),
  ...
  case object ADDRESS_OR_ALIAS
      extends FieldType(
        ...
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.account.AddressOrAlias"),
  ...
  case object PROOFS
      extends FieldType(
        ...
        scalaImports = Set("com.wavesplatform.transaction.Proofs", ProtoAdapterImport)
      )
      with BinarySerializableType
      with ProtoCompatibleType {
  ...
  abstract class OPTION_BASE(override val underlay: FieldType)
      extends FieldType(
        ...
        scalaImports = Set("com.wavesplatform.serialization.BinarySerializer") ++
  ...
  case object DATA_ENTRY
      extends FieldType(
        ...
        scalaImports = Set(
          "com.wavesplatform.state.DataEntry",
  ...
  case object CONTRACT_DATA_ENTRY
      extends FieldType(
        ...
        isMessageProtoType = true,
        scalaImports = Set(
          "com.wavesplatform.transaction.docker.ContractTransactionEntryOps",
          "com.wavesplatform.state.DataEntry",
          "scala.language.existentials",
          ProtoAdapterImport
        ),
  ...
  case object EXECUTABLE_TRANSACTION
      extends FieldType(
        ...
        isMessageProtoType = true,
        scalaImports = Set(
          "com.wavesplatform.transaction.docker.ExecutableTransaction",
          "com.wavesplatform.serialization.BinarySerializer",
          "com.wavesplatform.transaction.TransactionParsers",
          ProtoAdapterImport
        ),
  ...
  case object VALIDATION_PROOF
      extends FieldType(
        ...
        isMessageProtoType = true,
        scalaImports = Set("com.wavesplatform.transaction.docker.ValidationProof", ProtoAdapterImport),
  ...
  case object POLICY_DATA_HASH
      extends FieldType(
        ...
        protoType = "bytes",
        scalaImports = Set("com.wavesplatform.privacy.PolicyDataHash"),
        typeScriptType = Some("Base58WithLength")
      )
      with BinarySerializableType
      with ProtoCompatibleType {
  ...
  case object PERMISSION_OP_TYPE
      extends FieldType(
        scalaType = "OpType",
        protoType = "OpType",
        scalaImports = Set("com.wavesplatform.acl.OpType", ProtoAdapterImport),
  ...
  case object PERMISSION_OP
      extends FieldType(
        ...
        isMessageProtoType = true,
        scalaImports = Set("com.wavesplatform.acl.PermissionOp"),
  ...
  case object TRANSFER_BATCH
      extends FieldType(
        ...
        scalaImports = Set(
          "com.wavesplatform.transaction.transfer.ParsedTransfer",
          "com.wavesplatform.serialization.BinarySerializer",
          ProtoAdapterImport,
          "cats.implicits._"
        ),
  ...
  case object ATOMIC_INNER_TRANSACTION
      extends FieldType(
        ...
        scalaImports = Set(
          "com.wavesplatform.serialization.BinarySerializer",
          "com.wavesplatform.transaction.TransactionParsers",
          s"com.wavesplatform.serialization.${AtomicInnerTxAdapterGenerator.ObjectName}",
          "com.wavesplatform.transaction.docker.ExecutedContractTransaction"
        ),
  ...
  case object ATOMIC_BADGE
      extends FieldType(
        ...
        scalaImports = Set("com.wavesplatform.transaction.AtomicBadge", "com.wavesplatform.serialization.BinarySerializer", ProtoAdapterImport),
