package com.wavesplatform.transaction.generator.scala
...
object AtomicInnerTxAdapterGenerator {
  ...
  val PackageName = "com.wavesplatform.serialization"
  ...
  def buildWriter(schemes: Seq[TxScheme], skipContainers: Boolean = false): CodeWriter = {
    ...
    val imports = Seq(
      ...
      "com.wavesplatform.transaction.protobuf.{AtomicInnerTransaction => PbInnerTransaction}"
    ) ++ filteredSchemes
