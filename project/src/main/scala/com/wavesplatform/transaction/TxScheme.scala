...
import com.wavesplatform.transaction.generator.base.EssentialFields._
import com.wavesplatform.transaction.generator.base.FieldDefinitionSyntax._
import com.wavesplatform.transaction.generator.base.FieldGenerationOption.{Validation, _}
import com.wavesplatform.transaction.generator.base.FieldType._
import com.wavesplatform.transaction.generator.base.{BinaryHeaderType, BlockchainFeature, _}
import enumeratum._
...
sealed abstract class TxScheme(
  ...
  def protobufPackageName: String = {
    ...
    if (packageName == protoPackage)
      throw new IllegalArgumentException("The package name must start with 'com.wavesplatform.transaction'")
    else
      protoPackage
  }
...
object TxScheme extends Enum[TxScheme] {
  ...
  val BasePackage      = "com.wavesplatform.transaction"
  val BaseProtoPackage = "com.wavesplatform.transaction.protobuf"
  ...
  case object RegisterNodeTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation.RegisterNodeValidation._")
      )
  ...
  case object CreateAliasTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.crypto"),
        versionToBlockchainFeatures = { case 3 => Seq(BlockchainFeature.SponsoredFeesSupport) }
      )

  // region Assets

  private val assetsTxPackage = "com.wavesplatform.transaction.assets"
  ...
  case object IssueTransaction
      extends TxScheme(
        ...
        additionalImports = Set(
          "com.wavesplatform.transaction.validation._",
          "com.wavesplatform.transaction._",
          "java.nio.charset.StandardCharsets",
          "com.wavesplatform.state.ByteStr"
        ),
  ...
  case object ReissueTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation._", "com.wavesplatform.transaction._"),
        sealedTraitExtensions = Seq("ChainSpecific"),
  ...
  private val leaseTxPackage = "com.wavesplatform.transaction.lease"
  ...
  case object LeaseTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation.LeaseValidation._"),
        versionToBlockchainFeatures = { case 2 => Seq(BlockchainFeature.SmartAccounts) }
      )
  ...
  case object LeaseCancelTransaction
      extends TxScheme(
        ...
        sealedTraitExtensions = Seq("ChainSpecific"),
        additionalImports = Set("com.wavesplatform.transaction.validation.LeaseValidation._", "com.wavesplatform.transaction._"),
        versionToBlockchainFeatures = { case 2 => Seq(BlockchainFeature.SmartAccounts) }
      )
  ...
  case object SponsorFeeTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction._"),
  ...
  case object DataTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation.DataValidation._"),
  ...
  private val transferTxPackage = "com.wavesplatform.transaction.transfer"
  ...
  case object TransferTransaction
      extends TxScheme(
        ...
        additionalImports = Set(
          "com.wavesplatform.transaction.validation._",
          "com.wavesplatform.utils.Base58",
          "com.wavesplatform.transaction.AtomicInnerTransaction"
        ),
  ...
  case object MassTransferTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation._", "com.wavesplatform.utils.Base58"),
  ...
  case object PermitTransaction
      extends TxScheme(
        packageName = "com.wavesplatform.transaction.acl",
        typeId = 102,
        supportedVersions = Set(1, 2),
        fields = Seq(
          senderField,
        ...
        additionalImports = Set(
          "com.wavesplatform.transaction.validation.PermitValidation._",
          "com.wavesplatform.transaction.AtomicInnerTransaction"
        ),
  ...
  case object CreatePolicyTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.AtomicInnerTransaction"),
        versionExtensions = { case 3 => Seq("AtomicInnerTransaction") }
      )
  ...
  private val dockerTxPackage = "com.wavesplatform.transaction.docker"
  ...
  case object CallContractTransaction
      extends TxScheme(
        ...
        fields = Seq(
          ...
          feeField,
          timestampField,
          "contractVersion" as INT                  -> Set(Override, InBody({ case 1 => "1" }), InConstructor(2, 3, 4)),
        ...
        versionToBlockchainFeatures = {
          ...
          case 4 => Seq(BlockchainFeature.SponsoredFeesSupport, BlockchainFeature.AtomicTransactionSupport)
        },
        sealedTraitExtensions = Seq("ExecutableTransaction"),
        caseClassCompanionExtensions = Seq("ContractTransactionValidation"),
        additionalImports = Set("com.wavesplatform.transaction.AtomicInnerTransaction"),
        versionExtensions = { case 4 => Seq("AtomicInnerTransaction") }
      )
  ...
  case object ExecutedContractTransaction
      extends TxScheme(
        ...
        fields = Seq(
          ...
          "resultsHash"      as SHORT_BYTE_STR -> InConstructor(2),
          "validationProofs" as SHORT_LIST(VALIDATION_PROOF) -> InConstructor(2),
          timestampField,
        ...
        ensures = Seq("validateSize"),
        // TODO: is blocked by settings through TransactionDiffer as of 1.3.0, should use BlockchainFeature in 1.4.x
        // versionToBlockchainFeatures = { case 2 => Seq(BlockchainFeature.ValidateContracts) },
        caseClassCompanionExtensions = Seq("ContractTransactionValidation"),
        cacheSerializable = false,
        additionalImports = Set("com.wavesplatform.transaction.AtomicInnerTransaction"),
  ...
  private val smartTxPackage = "com.wavesplatform.transaction.smart"
  ...
  case object SetScriptTransaction
      extends TxScheme(
        ...
        additionalImports = Set(
          "com.wavesplatform.transaction.validation.validateChainId",
          "java.nio.charset.StandardCharsets",
          "com.wavesplatform.state.ByteStr",
          "com.wavesplatform.transaction.smart.SetScriptValidation._",
          "com.wavesplatform.account.AddressScheme"
        ),
        versionToBlockchainFeatures = {
          case 1 =>
            Seq(
  ...
  case object AtomicTransaction
      extends TxScheme(
        ...
        additionalImports = Set("com.wavesplatform.transaction.validation.AtomicValidation._"),
        isContainer = true
      )
