...
import com.wavesplatform.crypto.internals.{CryptoAlgorithms, CryptoError, InvalidAddress, KeyPair}
import com.wavesplatform.crypto.PublicKey
...
object Address extends ScorexLogging {
  ...
  def fromPublicKey(publicKey: Array[Byte],
                    ...
                    cryptoAlgorithms: CryptoAlgorithms[_ <: KeyPair] = com.wavesplatform.crypto.algorithms): Address = {
  ...
  def fromBytes(addressBytes: Array[Byte],
                chainId: Byte = scheme.chainId,
                cryptoAlgorithms: CryptoAlgorithms[_] = com.wavesplatform.crypto.algorithms): Either[CryptoError, Address] = {
    (for {
  ...
  def fromBytesUnsafe(
      ...
      chainId: Byte = scheme.chainId,
      cryptoAlgorithms: CryptoAlgorithms[_] = com.wavesplatform.crypto.algorithms
